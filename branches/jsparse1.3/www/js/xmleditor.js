...
//*******************************************************************************
function DefaultSchema2HtmlForm(_domTree , _tbody , _imagePrefix , _expandAll){
	return new ServiceDefinitionS2H(_domTree , _tbody , _imagePrefix , _expandAll);
}
...
//*******************************************************************************
function ServiceDefinitionS2H(_domTree , _table , _imagePrefix , _expandAll){
	...
	_printElementChildrens = function(_target , _element){
		...
		for(var i=0;i<childrens.length;i++){
			if(!childrens[i].isLeaf){
				if(expandAll){
					_printElement(_target , childrens[i]);
