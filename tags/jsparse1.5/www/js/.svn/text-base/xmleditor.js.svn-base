...
function MutliNSSchema2HtmlForm(_domTree , _handle){
	...
	_elementToTr = function(_element , _layer){
		...
		//element name
		var imgHelp = createHtmlElement(_HTML_ELEMENT_IMG);
		imgHelp.src = _HTML_ELEMENT_IMG_HELP_SRC;
		imgHelp.width = 12;
		imgHelp.height = 12;
	...
	_elementValueToTr = function(_element , _layer){
		...
		var span = createHtmlElement("span");
		span.id = prefix;
		span.appendChild(createHtmlTextElement(_element.value));
