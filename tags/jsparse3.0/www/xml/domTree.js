...
function DefaultDomTree(_reader){
	...
	_createNewElement = function(_parse, _eName){
		...
		e.setRule(_parse.findElementStructRule(_eName));
		e.setContentRule(_parse.findElementContentRule(_eName));
		...
		//examine whether element is a leaf of the tree.
		var cs = _parse.findElementChildrens(_eName);
