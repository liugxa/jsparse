...
var RULE_VALIDATE_NOT_PATTERN_1 = "The value can only contain the following characters: letters , numbers, _ ,and its length must less than 40 letters,but the first letter can not be digit.";
var RULE_VALIDATE_NOT_PATTERN_2 = "The value can only contain the printable letters, space character, including space, tab, form feed, line feed and its length must less than 128 letters.";
...
function MultiNSSchemaParse(_sXmlDoc , _nameSpace , _standNS){
	...
	_findDocumentationOfSimpeType = function(_simpleType){
		...
		if(anno != null) r = _getFirstNodeOfElement(_simpleType , "documentation");
		return r;
	}
